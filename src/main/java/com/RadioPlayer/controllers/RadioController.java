package com.RadioPlayer.controllers;
...
public class RadioController {
    ...
    public void editPlayerInformations(String PlayerName, String name, String imgSongPath, String imgMediaPath) {
		...
		imgRadioMainScreenMusicImage.setImage(new Image(this.getClass().getResourceAsStream(imgSongPath)));
		imgRadioMainScreenStationLogo.setImage(new Image(this.getClass().getResourceAsStream(imgMediaPath)));
    }
